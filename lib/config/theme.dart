...
extension CopyWithTextTheme on TextTheme {
  TextTheme copyWithTextTheme({Color? color, ColorScheme? colorScheme}) {
    ...
    return copyWith(
      ...
      bodyLarge: bodyLarge?.copyWith(color: colorScheme?.onBackground ?? color, fontFamily: fontFamily, fontSize: 16),
    );
  }
}
...
class AppTheme {
  ...
  static ThemeData getThemeData(ThemeMode mode) {
    ...
    return ThemeData(
      ...
      useMaterial3: true,
      tooltipTheme: TooltipThemeData(textStyle: data.textTheme.bodySmall?.copyWith(color: Colors.white), decoration: BoxDecoration(color: Colors.black, borderRadius: BorderRadius.circular(8))),
      textSelectionTheme: TextSelectionThemeData(cursorColor: data.colorScheme.primary, selectionColor: data.colorScheme.primary.withOpacity(0.5)),
      ...
      iconTheme: IconThemeData(color: data.colorScheme.onBackground, size: 30),
      ...
      expansionTileTheme: ExpansionTileThemeData(backgroundColor: data.colorScheme.background, collapsedBackgroundColor: data.colorScheme.background),
      ...
      listTileTheme: ListTileThemeData(tileColor: data.colorScheme.background, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8))),
